...
>
> 예제 코드는 [https://github.com/gurugio/my-rust-book](https://github.com/gurugio/my-rust-book)에서 다운받을 수 있습니다.
>
...
출처 link: [https://doc.rust-lang.org/book/ch19-04-advanced-types.html](https://doc.rust-lang.org/book/ch19-04-advanced-types.html)
...
우선 String([https://doc.rust-lang.org/std/string/struct.String.html](https://doc.rust-lang.org/std/string/struct.String.html)) 이라는 타입에 대해서 알아보겠습니다.
...
출처: [https://doc.rust-lang.org/src/alloc/string.rs.html#365](https://doc.rust-lang.org/src/alloc/string.rs.html#365)
...
VSCODE를 예를 들면 Inlay hints [https://code.visualstudio.com/docs/languages/rust#_inlay-hints](https://code.visualstudio.com/docs/languages/rust#_inlay-hints) 나 Linting [https://code.visualstudio.com/docs/languages/rust#_linting](https://code.visualstudio.com/docs/languages/rust#_linting) 등의 기능이 있어서, cargo를 호출하기전에 코드를 쓰는 단계에서 미리 거의 모든 컴파일 에러를 잡을 수 있습니다.
...
The Rust Programming Language([https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html))에서는 소유권이라는 것이 3가지 규칙을 의미한다고 설명합니다.
...
참고: [https://doc.rust-lang.org/std/iter/trait.IntoIterator.html#tymethod.into_iter](https://doc.rust-lang.org/std/iter/trait.IntoIterator.html#tymethod.into_iter)
...
참고로 iter메소드는 불변 레퍼런스를 만듭니다. for루프안에서 user데이터를 읽기만하고 쓸수는 없습니다. 만약 user데이터를 수정하고 싶다면 iter_mut 메소드를 써서 가변 레퍼런스를 만들면됩니다. iter_mut 메소드의 메뉴얼([https://doc.rust-lang.org/std/slice/struct.IterMut.html](https://doc.rust-lang.org/std/slice/struct.IterMut.html))을 참고하세요.
...
[https://doc.rust-lang.org/std/#primitives](ttps://doc.rust-lang.org/std/#primitives)
...
출처: [https://doc.rust-lang.org/rust-by-example/custom_types/structs.html](https://doc.rust-lang.org/rust-by-example/custom_types/structs.html)
...
출처: [https://doc.rust-lang.org/std/result/](https://doc.rust-lang.org/std/result/)
...
출처: [https://doc.rust-lang.org/std/option/enum.Option.html](https://doc.rust-lang.org/std/option/enum.Option.html)
...
[https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.map](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.map)
...
출처: [https://doc.rust-lang.org/std/option/enum.Option.html#method.map](https://doc.rust-lang.org/std/option/enum.Option.html#method.map)
...
러스트 컴파일러(rustc)가 한번에 처리하는 코드를 크레이트라고 정의한다고 합니다. (출처: [https://doc.rust-lang.org/book/ch07-01-packages-and-crates.html](https://doc.rust-lang.org/book/ch07-01-packages-and-crates.html)) 사실 정의만 보면 잘 이해가 안되는데 쉽게 말해서 지금 내가 만들고있는게 하나의 실행 파일이나, 하나의 라이브러리이면 각각이 바로 하나의 크레이트입니다.
